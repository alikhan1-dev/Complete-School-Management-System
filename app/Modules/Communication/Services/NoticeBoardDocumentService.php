...
/**
 * CI media_storage path: uploads/notice_board_images/
 * SaaS storage quota deferred.
 */
class NoticeBoardDocumentService
{
    public const FOLDER = 'notice_board_images';

    public function directory(): string
    {
        return public_path('uploads/'.self::FOLDER);
    }
