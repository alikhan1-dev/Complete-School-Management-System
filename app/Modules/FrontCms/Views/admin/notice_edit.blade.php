@php
    ...
    $result = $result ?? [];
    $val = function (string $key, $fallback = '') use ($old, $result, $notices) {
        ...
        if ($key === 'date') {
            return $notices->formatDate($result['date'] ?? null);
        }
...
@endphp
<form action="{{ url('admin/front/notice/edit/'.$result['slug']) }}" method="post">
    @csrf
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="date" value="{{ $val('date') }}">
