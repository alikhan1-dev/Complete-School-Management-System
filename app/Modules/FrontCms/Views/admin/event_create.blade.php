...
@endphp
<form action="{{ url('admin/front/events/create') }}" method="post">
    @csrf
    <div class="row">
        <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="start_date" value="{{ $val('start_date', $today ?? '') }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="end_date" value="{{ $val('end_date', $today ?? '') }}">
