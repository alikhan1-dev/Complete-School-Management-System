...
<div class="row">
    <div class="col-md-4">
        @can('privilege', ['expense_head', 'can_add'])
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title">Add Expense Head</h3></div>
            <form method="post" action="{{ route('finance.expense_heads.store') }}">
                @csrf
                <div class="box-body">
                    <div class="form-group">
                        <label>Expense Head</label> <small class="req">*</small>
                        <input type="text" name="expensehead" class="form-control" value="{{ old('expensehead') }}" required>
                    </div>
                    <div class="form-group">
