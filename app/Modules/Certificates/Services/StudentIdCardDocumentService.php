...
/**
 * CI media_storage uploads for student ID card templates.
 * Paths: uploads/student_id_card/{background|logo|signature}/
 * SaaS storage quota deferred.
 */
class StudentIdCardDocumentService
{
    public const BASE = 'student_id_card';
