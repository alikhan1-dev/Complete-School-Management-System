...
/**
 * CI media_storage path: uploads/front_office/dispatch_receive/
 * SaaS storage quota deferred.
 */
class DispatchReceiveDocumentService
{
    public function directory(): string
    {
        return public_path('uploads/front_office/dispatch_receive');
    }
