...
/**
 * CI media_storage path: uploads/onlinexam_images/
 * SaaS storage quota checks deferred.
 */
class OnlineExamDocumentService
{
    public function directory(): string
    {
        return public_path('uploads/onlinexam_images');
    }
    ...
    /**
     * CI Media_storage::fileupload naming: time-uniqid!original.ext
     */
