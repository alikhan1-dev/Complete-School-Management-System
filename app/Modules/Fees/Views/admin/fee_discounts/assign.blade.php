...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Assign Fees Discount — {{ $discount->name }} ({{ $discount->code }})</h3>
        <div class="box-tools">
            <a href="{{ route('fees.fee_discounts.index') }}" class="btn btn-default btn-sm">Back</a>
        </div>
    </div>
    <div class="box-body">
        <form method="post" action="{{ route('fees.fee_discounts.assign', $discount->id) }}" class="row">
            @csrf
            <div class="col-sm-3">
...
@if($resultList !== null)
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form method="post" action="{{ route('fees.fee_discounts.assign_save') }}">
                @csrf
                <input type="hidden" name="feediscount_id" value="{{ $discount->id }}">
                            ...
                            <tr>
                                <td>
                                    <input class="checkbox" type="checkbox" name="student_session_id[]"
                                           ...
                                           @checked((int) $student->student_fees_discount_id !== 0)>
                                    <input type="hidden" name="student_list[]" value="{{ $student->student_session_id }}">
                                </td>
