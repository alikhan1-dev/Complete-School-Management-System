...
<div class="row">
    <div class="col-md-4">
        @can('privilege', ['fees_group', 'can_add'])
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title">Add Fees Group</h3></div>
            <form method="post" action="{{ route('fees.fee_groups.store') }}">
                @csrf
                <div class="box-body">
