...
| **3** | **Fees** (delivery pivot: Fees first; Attendance follows as 3b) — was Phase 4 in original plan | In progress (operational core done incl. multi-collect, due-fees, carry-forward + transport single collect + offline bank payments admin/portal; deferred: transport multi-collect, student getfees ledger UI, print/SMS) |
