...
| **7** | Communication, Chat, FrontCms, FrontOffice, OnlineAdmission | In progress (Communication persist + staff/user Chat persist/polling + FrontOffice admission enquiry persist done; FrontCms/OnlineAdmission pending; live send deferred) |
