...
| **7** | Communication, Chat, FrontCms, FrontOffice, OnlineAdmission | In progress (Communication persist + staff/user Chat persist/polling + FrontOffice persist slices done; FrontCms/OnlineAdmission pending; live send + SaaS quota deferred) |
