...
| **6** | Library, Transport, Hostel, Inventory, Payroll, Leave, Homework, LessonPlan | In progress (Homework + Library + Transport operational core + Hostel + Inventory + Payroll + Leave incl. student approve_leave class-teacher scope done; LessonPlan core + full admin class-teacher scope incl. weekly matrix done; deferred: student portal comments) |
