...
| **6** | Library, Transport, Hostel, Inventory, Payroll, Leave, Homework, LessonPlan | In progress (Homework core + reports hub/homework/evaluation/marks done; daily assignment report + mail deferred; others pending) |
