...
| **6** | Library, Transport, Hostel, Inventory, Payroll, Leave, Homework, LessonPlan | In progress (Homework admin + evaluation + student portal + daily assignment done; reports deferred; others pending) |
