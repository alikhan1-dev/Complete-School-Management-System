...
| **4** | Finance, Payments (gateway infrastructure) | In progress (Finance heads + income/expense CRUD + search screens done; Payments admin method credentials + online admission checkout persist done; live gateways pending; finance reports owned by Reports) |
