...
| **3** | **Fees** (delivery pivot: Fees first; Attendance follows as 3b) — was Phase 4 in original plan | In progress (operational core done incl. multi-collect, due-fees, carry-forward + transport single/multi collect + offline bank payments + student getfees portal ledger/print + printFeesByName/ByGroup/ByGroupArray + cumulative fine; deferred: online gateway pay, thermal print, SMS, processing-fee banner) |
