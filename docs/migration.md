...
| **3b** | Attendance (day / subject / staff) + remaining student history | Operational core done (day + by-date + subject/period + staff mark-save + period reportbydate + day/by-date + subject/period class-teacher scope); deferred: SMS, biometric |
...
| **6** | Library, Transport, Hostel, Inventory, Payroll, Leave, Homework, LessonPlan | In progress (Homework incl. homework report class-teacher scope + Library incl. book issue empty-matrix deny + library reports superadmin_visible staff masking + Transport incl. student transport report class-teacher scope + Hostel incl. student hostel report class-teacher scope + Transport operational core + Hostel + Inventory + Payroll + Leave incl. student approve_leave class-teacher scope done; LessonPlan core + full admin class-teacher scope incl. weekly matrix done; deferred: student portal comments) |
