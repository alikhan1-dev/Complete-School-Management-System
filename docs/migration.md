...
| **7** | Communication, Chat, FrontCms, FrontOffice, OnlineAdmission | In progress (Communication persist slices + staff Chat persist/polling done; FrontCms/FrontOffice/OnlineAdmission pending; live send deferred) |
