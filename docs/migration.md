...
| **5** | Exams, OnlineExam, Certificates | In progress (Exams + OnlineExam admin done; Certificates student cert + ID card templates/generate done; staff ID/TC/portal pending) |
