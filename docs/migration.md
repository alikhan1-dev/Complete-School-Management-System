...
| **6** | Library, Transport, Hostel, Inventory, Payroll, Leave, Homework, LessonPlan | In progress (Homework incl. homework report class-teacher scope + Library incl. book issue empty-matrix deny + Transport operational core + Hostel + Inventory + Payroll + Leave incl. student approve_leave class-teacher scope done; LessonPlan core + full admin class-teacher scope incl. weekly matrix done; deferred: student portal comments) |
