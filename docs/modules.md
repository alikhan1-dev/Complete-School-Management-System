...
| **Library** | Books & issues | `admin/Book.php`, `admin/Member.php` | `books`, `book_issues`, `libarary_members` | `app/Modules/Library/` | In progress (books CRUD + members enroll/surrender done; issue/return/import/reports deferred) |
