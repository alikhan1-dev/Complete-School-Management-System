...
| **Exams** | Exam groups & exams in group | `admin/Examgroup.php` | `exam_groups`, `exam_group_class_batch_exams` | `app/Modules/Exams/` | In progress (group + exam CRUD done; subjects/assign/marks/link deferred) |
