...
| **FrontCms** | Public website CMS | `admin/Frontcms.php`, `admin/front/*`, `Welcome.php` | `front_cms_*` | `app/Modules/FrontCms/` | In progress (admin persist + public site done; deferred: SaaS quota, live YouTube oEmbed, live contact/complain mail, Welcome admission/examresult, CI theme pixel-parity) |
...
| **OnlineAdmission** | Online admission forms & payment | `admin/Onlineadmission.php`, `admin/Onlinestudent.php`, `onlineadmission/*`, `Welcome.php` | `online_admissions`, `online_admission_*` | `app/Modules/OnlineAdmission/` | In progress (admin settings + form fields + application list/edit/enroll/delete persist done; deferred: public Welcome admission/examresult, payment gateways, fees/transport on enroll, live mail/SMS, barcode, SaaS quota) |
