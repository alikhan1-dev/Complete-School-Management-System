...
| **Fees** | Fee collection & discounts | `Studentfee.php`, `admin/Feediscount.php`, `admin/Feesforward.php` | `student_fees`, `student_fees_master`, `student_fees_deposite`, `student_fees_discounts`, `fees_discounts`, `student_applied_discounts` | `app/Modules/Fees/` | In progress (collect + multi + due-fees + carry-forward + transport single collect done; deferred: transport multi-collect, print/SMS) |
| **Fees** | Transport fees | `Studentfee.php` | `student_transport_fees`, `transport_feemaster` | `app/Modules/Fees/` | In progress (ledger + single deposit on addfee done; multi-collect + fees-master admin deferred to Transport) |
| **Fees** | Offline fee payments | `admin/Offlinepayment.php`, `user/Offlinepayment.php` | `offline_fees_payments` | `app/Modules/Fees/` | In progress (admin list/view/approve/reject/download + portal start/submit/list/view/download done; deferred: student getfees ledger entry UI, DataTables AJAX pixel-parity, SaaS quota) |
