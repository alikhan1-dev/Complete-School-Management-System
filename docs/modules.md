...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information + Attendencereports full + Financereports through incomeexpensebalancereport persist done; deferred: income/expense/group DT, Balancefees, transport fee lines, class-teacher scope, view-students modal, CI pixel-parity JS, student_profile custom-field columns) |
