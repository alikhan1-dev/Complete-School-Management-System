...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information hub through online admission report persist done; deferred: Attendencereports/Financereports/Balancefees, class-teacher scope, view-students modal, CI pixel-parity JS, student_profile custom-field columns) |
