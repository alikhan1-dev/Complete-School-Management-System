...
| **Library** | Books & issues | `admin/Book.php`, `admin/Member.php` | `books`, `book_issues`, `libarary_members` | `app/Modules/Library/` | In progress (books CRUD done; import/members/issue/return/reports deferred) |
