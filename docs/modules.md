...
| **Staff** | Staff list (DataTables) | `admin/Staff.php` | `staff`, `staff_roles`, `staff_designation`, `department` | `Staff/Controllers/StaffController.php` | In progress (list/DataTables + create + edit + profile + attendance AJAX + documents + timeline + disable/enable done; deferred: import, SaaS quota) |
| **Staff** | Staff CRUD, documents, timeline | `admin/Staff.php`, `admin/Timeline.php` | `staff`, `staff_timeline`, `staff_attendance` | `app/Modules/Staff/` | In progress (create + edit + profile + documents + timeline + disable/enable done; staff delete/import pending) |
