...
| **Exams** | Exam groups & exams in group | `admin/Examgroup.php` | `exam_groups`, `exam_group_class_batch_exams` | `app/Modules/Exams/` | In progress (group + exam + exam subjects CRUD done; assign/marks/link deferred) |
