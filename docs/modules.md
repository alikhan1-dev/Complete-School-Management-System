...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information + Attendencereports full + Financereports core complete except incomegroup/expensegroup; deferred: group reports, Balancefees, transport fee lines, class-teacher scope, view-students modal, CI pixel-parity JS/DataTables, student_profile custom-field columns) |
