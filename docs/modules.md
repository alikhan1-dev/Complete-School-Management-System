...
| **OnlineAdmission** | Online admission forms & payment | `admin/Onlineadmission.php`, `admin/Onlinestudent.php`, `onlineadmission/*`, `Welcome.php` | `online_admissions`, `online_admission_*` | `app/Modules/OnlineAdmission/` | In progress (admin persist + enroll + public form/review/submit/edit + checkout + applicant file persist done; deferred: live gateway APIs, captcha, custom fields, examresult, live mail/SMS, SaaS quota) |
