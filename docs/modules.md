...
| **OnlineExam** | Online exams & question bank | `admin/Onlineexam.php`, `admin/Question.php` | `onlineexam`, `onlineexam_questions`, `onlineexam_students`, `questions` | `app/Modules/OnlineExam/` | In progress (admin core + student take-exam objective/descriptive+upload done; ranking/reports/mail deferred) |
...
| **FrontCms** | Public website CMS | `admin/Frontcms.php`, `admin/front/*`, `Welcome.php` | `front_cms_*` | `app/Modules/FrontCms/` | In progress (admin persist + public site done; deferred: SaaS quota, live YouTube oEmbed, live contact/complain mail, Welcome examresult, CI theme pixel-parity) |
...
| **Settings** | School settings, modules, themes | `Schsettings.php`, `admin/Module.php`, `Theme.php`, `admin/Currency.php`, `admin/Captcha.php` | `sch_settings`, `sidebar_menus`, `currencies`, `captcha` | `app/Modules/Settings/` | In progress (captcha setting persist done; deferred: remaining school/module/theme/currency settings) |
