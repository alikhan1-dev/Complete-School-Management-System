...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information + Attendencereports + Financereports + Balancefees/due_fees_report + Human Resource hub/staff_report + Lesson Plan syllabus/teacher reports persist done; deferred: transport fee lines, class-teacher scope, view-students modal, CI pixel-parity JS/DataTables/Chart.js, student_profile custom-field columns) |
