...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information + Attendencereports hub/daywise/daily/type + monthly student/staff calendars persist done; deferred: period/subject/biometric attendance reports, Financereports/Balancefees, class-teacher scope, view-students modal, CI pixel-parity JS, student_profile custom-field columns) |
