...
| **Exams** | Exam groups & exams in group | `admin/Examgroup.php` | `exam_groups`, `exam_group_*`, `exam_group_exam_connections`, `exam_group_exam_results` | `app/Modules/Exams/` | In progress (Examgroup core done incl. link exams + publish flags; marksheets/SMS deferred) |
