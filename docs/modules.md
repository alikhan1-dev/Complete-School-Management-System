...
| **Reports** | Academic, attendance, finance reports | `Report.php`, `Attendencereports.php`, `Financereports.php`, `Balancefees.php` | (reads many domain tables) | `app/Modules/Reports/` | In progress (student information hub + student report + class/section counts + gender/teacher ratio + guardian + student history + student/parent login credentials persist done; deferred: remaining Report/Attendencereports/Financereports/Balancefees screens, class-teacher scope, view-students modal, CI pixel-parity JS) |
