...
| **OnlineAdmission** | Online admission forms & payment | `admin/Onlineadmission.php`, `admin/Onlinestudent.php`, `onlineadmission/*`, `Welcome.php` | `online_admissions`, `online_admission_*` | `app/Modules/OnlineAdmission/` | In progress (admin persist + enroll + public form/review/submit/edit done; deferred: payments, captcha, custom fields, file uploads, examresult, live mail/SMS, SaaS quota) |
