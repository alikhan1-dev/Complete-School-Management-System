...
| **Attendance** | Student attendance | `admin/Stuattendence.php`, `admin/Subjectattendence.php` | `student_attendences`, `student_subject_attendances`, `attendence_type` | `app/Modules/Attendance/` | Pending |
| **Attendance** | Staff attendance | `admin/Staffattendance.php` | `staff_attendance`, `staff_attendance_type`, `staff_attendence_schedules` | `app/Modules/Attendance/` | Pending |
| **Fees** | Fee types, groups, masters | `Feetype.php`, `Feemaster.php`, `admin/Feegroup.php` | `feetype`, `feemasters`, `fee_groups`, `fee_groups_feetype`, `fee_session_groups` | `app/Modules/Fees/` | Pending |
| **Fees** | Fee collection & discounts | `Studentfee.php`, `admin/Feediscount.php`, `admin/Feesforward.php` | `student_fees`, `student_fees_master`, `student_fees_deposite`, `student_fees_discounts`, `fees_discounts` | `app/Modules/Fees/` | Pending |
...
| **Certificates** | ID cards, certificates, TC | `admin/Certificate.php`, `admin/Generatecertificate.php`, `admin/Transfercertificate.php`, `admin/Studentidcard.php` | `certificates`, `id_card`, `staff_id_card`, `transfer_certificate_*` | `app/Modules/Certificates/` | Pending |
