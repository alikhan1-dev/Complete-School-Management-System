...
| **Homework** | Homework & daily assignments | `Homework.php`, `admin/` (homework views) | `homework`, `homework_evaluation`, `daily_assignment`, `submit_assignment` | `app/Modules/Homework/` | In progress (CRUD + evaluation + portal + daily + core reports done; daily assignment report + mail deferred) |
