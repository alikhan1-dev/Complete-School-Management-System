...
| **OnlineExam** | Online exams & question bank | `admin/Onlineexam.php`, `admin/Question.php` | `onlineexam`, `onlineexam_questions`, `onlineexam_students`, `questions` | `app/Modules/OnlineExam/` | In progress (admin core + student take-exam objective/descriptive+upload + online exams hub/exams report done; deferred: attempt/rank/result reports, ranking generation, mail/SMS) |
