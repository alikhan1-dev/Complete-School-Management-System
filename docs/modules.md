...
| **Staff** | Staff list (DataTables) | `admin/Staff.php` | `staff`, `staff_roles`, `staff_designation`, `department` | `Staff/Controllers/StaffController.php` | In progress (list/DataTables + create persist done; deferred: edit/profile/documents/timeline/import, SaaS quota, credential mail/SMS) |
| **Staff** | Staff CRUD, documents, timeline | `admin/Staff.php`, `admin/Timeline.php` | `staff`, `staff_timeline`, `staff_attendance` | `app/Modules/Staff/` | In progress (create done; edit/delete/profile/documents/timeline pending) |
