...
| **Students** | Disable / alumni | `admin/Disable_reason.php`, `admin/Alumni.php` | `disable_reason`, `alumni_students`, `alumni_events` | `app/Modules/Students/` | In progress (disable reason + alumni list/details + events done; alumni mail/SMS + calendar deferred) |
