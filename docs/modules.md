...
| **Communication** | Email, SMS, notifications | `admin/Mailsms.php`, `admin/Notification.php`, `Emailconfig.php`, `Smsconfig.php` | `messages`, `send_notification`, `email_config`, `sms_config`, `notification_setting` | `app/Modules/Communication/` | In progress (email_config + sms_config save done; deferred: notice board, compose mail/SMS, templates, test send, Chat, FrontCms) |
