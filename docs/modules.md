...
| **Chat** | In-app chat | `admin/Chat.php`, `user/Chat.php` | `chat_users`, `chat_connections`, `chat_messages` | `app/Modules/Chat/` | In progress (staff admin persist + polling done; deferred: user/parent portal) |
