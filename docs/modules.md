...
| **Homework** | Homework & daily assignments | `Homework.php`, `admin/` (homework views) | `homework`, `homework_evaluation`, `daily_assignment`, `submit_assignment` | `app/Modules/Homework/` | In progress (admin CRUD + evaluation + student portal + daily assignment done; reports/mail deferred) |
